...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c2son90.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c2son90.containers.anotherwebservice.com/
...
```
git clone git@github.com:ndg23/container-c2son90.git
cd container-c2son90
```
...
```
docker attach container-c2son90
```
